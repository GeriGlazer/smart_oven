...
import UserRecipes from "../recipe/userRecipes/userRecipes";
import Recomendations from "../recipe/recomendations/recomendations";
    ...
    return (
        <div className="routing">
			<Routes>
                ...
                <Route path="recipe/userRecipes" element={<UserRecipes/>}/>
                <Route path="recipe/recomendations" element={<Recomendations/>}/>
